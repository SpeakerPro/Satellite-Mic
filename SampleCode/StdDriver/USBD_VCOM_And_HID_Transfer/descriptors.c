...
uint8_t gu8ConfigDescriptor[] = {	
    ...
    EP_INT,                         /* bmAttributes */
    /* wMaxPacketSize */
    EP6_MAX_PKT_SIZE & 0x00FF, (EP6_MAX_PKT_SIZE & 0xFF00) >> 8,
    HID_DEFAULT_INT_IN_INTERVAL /* bInterval */
};
...
const uint8_t gu8ProductStringDesc[] =
{
    44,             /* bLength          */
    DESC_STRING,    /* bDescriptorType  */
    'I', 0, 'M', 0, ' ', 0, 'W', 0, 'i', 0, 'r', 0, 'e', 0, 'l', 0, 'e', 0, 's', 0, 's', 0, ' ', 0, 'M', 0, 'i', 0, 'c', 0, ' ', 0, 'D', 0, 'S', 0, '1', 0, '0', 0, '0', 0
};
...
const uint8_t gu8StringSerial[26] =
{
    26,             // bLength
    DESC_STRING,    // bDescriptorType
    'A', 0, '0', 0, '2', 0, '0', 0, '2', 0, '2', 0, '0', 0, '6', 0, '3', 0, '0', 0, '0', 0, '1', 0
};
