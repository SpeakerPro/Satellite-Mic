...
#define CLI_ABBR_VERSION_ATS3607                "vats"

#define CLI_ABBR_USB_VID                        "vid"
#define CLI_ABBR_USB_PID                        "pid"
...
#define CLI_ABBR_TIP_VERSION_ATS3607            "[Version]: Version of ATS3607"

#define CLI_ABBR_TIP_USB_VID                    "[Config]: USB VID"
#define CLI_ABBR_TIP_USB_PID                    "[Config]: USB PID"
...
bool cmd_parse(INT argc, PCHAR argv[], cmd_parse_s* parse_info)
{
    ...
    memcpy(cli_params[cli_params_count].abbr, CLI_ABBR_VERSION_ATS3607, strlen(CLI_ABBR_VERSION_ATS3607));
    cli_params[cli_params_count].parameters = FALSE;
    cli_params[cli_params_count].tip = CLI_ABBR_TIP_VERSION_AW5808_TX;
    parse_info->version_ats = &cli_params[cli_params_count].pParam;
    cli_params_count++;

    memcpy(cli_params[cli_params_count].abbr, CLI_ABBR_USB_VID, strlen(CLI_ABBR_USB_VID));
    cli_params[cli_params_count].parameters = TRUE;
    cli_params[cli_params_count].tip = CLI_ABBR_TIP_USB_VID;
    parse_info->vid = &cli_params[cli_params_count].pParam;
    cli_params_count++;

    memcpy(cli_params[cli_params_count].abbr, CLI_ABBR_USB_PID, strlen(CLI_ABBR_USB_PID));
    cli_params[cli_params_count].parameters = TRUE;
    cli_params[cli_params_count].tip = CLI_ABBR_TIP_USB_PID;
    parse_info->pid = &cli_params[cli_params_count].pParam;
    cli_params_count++;

    memcpy(cli_params[cli_params_count].abbr, CLI_ABBR_VERSION_AW5808_TX, strlen(CLI_ABBR_VERSION_AW5808_TX));
    cli_params[cli_params_count].parameters = FALSE;
    cli_params[cli_params_count].tip = CLI_ABBR_TIP_VERSION_ATS3607;
